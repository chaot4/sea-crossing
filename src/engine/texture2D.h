...
public:
	...
	* \param internal_format Specifies the internal format of the texture (e.g. GL_RGBA)
	* \param dim_x Specifies the width of the texture in pixels.
	* \param dim_y Specifies the height of the texture in pixels.
	* \param format Specifies the format of the texture (e.g. GL_RGBA32F)
	...
	*/
	bool load(GLenum internal_format, int dim_x, int dim_y, GLenum format, GLenum type, GLvoid * data);
