...
Mesh::Mesh() : m_filename("0"), m_num_vertices(0), m_va_handle(0), m_vbo_handle(0), m_ibo_handle(0)
{
}
...
Mesh::Mesh(const std::string fn) : m_filename(fn), m_va_handle(0), m_vbo_handle(0), m_ibo_handle(0)
{
}
