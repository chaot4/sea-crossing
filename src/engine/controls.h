...
{
public:
	Controls() : x_axis(1.0,0.0,0.0), y_axis(0.0,1.0,0.0), latest_cursor_position(0.0,0.0),latest_y_rotation(0.0),latest_x_rotation(0.0), latest_radius(20.0) {}
	~Controls() {}
...
private:
	...
	float latest_y_rotation;
	float latest_x_rotation;
	float latest_radius;
};
